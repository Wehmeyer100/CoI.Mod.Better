...
namespace CoI.Mod.Better.Edicts
{
	internal partial class VehicleEdicts : IModData
	{
		...
		private void GenerateResearch(ProtoRegistrator registrator)
		{
			...
			ResearchNodeProto research_t2 = GenerateResearchEdict(registrator, MyIDs.Research.VehicleEdictsResearchT2, "Vehicle Edict Plus II", BetterMod.Config.VehicleEdicts.ResearchCostT2, research_t1, false, Eticts.Trucks.CapacityIncT2, Eticts.Trucks.FuelReductionT2, Eticts.Trucks.MaintenanceReductionT2);

			ResearchNodeProto research_t3 = GenerateResearchEdict(registrator, MyIDs.Research.VehicleEdictsResearchT3, "Vehicle Edict Plus III", BetterMod.Config.VehicleEdicts.ResearchCostT3, research_t2, false, Eticts.Trucks.CapacityIncT3, Eticts.Trucks.FuelReductionT3, Eticts.Trucks.MaintenanceReductionT3);

			ResearchNodeProto research_t4 =GenerateResearchEdict(registrator, MyIDs.Research.VehicleEdictsResearchT4, "Vehicle Edict Plus IV", BetterMod.Config.VehicleEdicts.ResearchCostT4, research_t3, false, Eticts.Trucks.CapacityIncT4, Eticts.Trucks.FuelReductionT4, Eticts.Trucks.MaintenanceReductionT4);
