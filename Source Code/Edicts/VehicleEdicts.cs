...
namespace CoI.Mod.Better.Edicts
{
    internal partial class VehicleEdicts : IModData
    {
        ...
        private void GenerateResearch(ProtoRegistrator registrator)
        {
            ...
            ResearchNodeProto research_t1 = GenerateResearchEdict(registrator, MyIDs.Research.VehicleEdictsResearchT1, "Vehicle Edict Plus I", BetterMod.Config.VehicleEdicts.ResearchCostT1, true, new ResearchNodeUIData(master_research, false, BetterMod.UIStepSize, (BetterMod.UIStepSize * 5)), MyIDs.Eticts.Trucks.CapacityIncT1, MyIDs.Eticts.Trucks.FuelReductionT1, MyIDs.Eticts.Trucks.MaintenanceReductionT1);
            ResearchNodeProto research_t2 = GenerateResearchEdict(registrator, MyIDs.Research.VehicleEdictsResearchT2, "Vehicle Edict Plus II", BetterMod.Config.VehicleEdicts.ResearchCostT2, true, research_t1, false, MyIDs.Eticts.Trucks.CapacityIncT2, MyIDs.Eticts.Trucks.FuelReductionT2, MyIDs.Eticts.Trucks.MaintenanceReductionT2);
            ResearchNodeProto research_t3 = GenerateResearchEdict(registrator, MyIDs.Research.VehicleEdictsResearchT3, "Vehicle Edict Plus III", BetterMod.Config.VehicleEdicts.ResearchCostT3, true, research_t2, false, MyIDs.Eticts.Trucks.CapacityIncT3, MyIDs.Eticts.Trucks.FuelReductionT3, MyIDs.Eticts.Trucks.MaintenanceReductionT3);
            ResearchNodeProto research_t4 = GenerateResearchEdict(registrator, MyIDs.Research.VehicleEdictsResearchT4, "Vehicle Edict Plus IV", BetterMod.Config.VehicleEdicts.ResearchCostT4, true, research_t3, false, MyIDs.Eticts.Trucks.CapacityIncT4, MyIDs.Eticts.Trucks.FuelReductionT4, MyIDs.Eticts.Trucks.MaintenanceReductionT4);
            GenerateResearchEdict(registrator, MyIDs.Research.VehicleEdictsResearchT5, "Vehicle Edict Plus V", BetterMod.Config.VehicleEdicts.ResearchCostT4, true, research_t4, false);
