...
namespace CoI.Mod.Better.Edicts
{
    internal partial class VehicleEdicts : IModData
    {
        private static void Cheats(ProtoRegistrator registrator)
        {
            ...
            ResearchNodeProto research_cheat_t1 = ResearchProtoUtility.GenerateResearchEdict(registrator, MyIDs.Research.VehicleEdictsResearchCheat_T1, "Vehicle Edict I Cheat", BetterMod.Config.Default.CheatResearchCosts, true, new ResearchNodeUIData(master_cheat_research, true, BetterMod.UIStepSize * 2, 0), MyIDs.Eticts.Trucks.CapacityIncT1_CHEAT, MyIDs.Eticts.Trucks.FuelReductionT1_CHEAT, MyIDs.Eticts.Trucks.MaintenanceReductionT1_CHEAT);
