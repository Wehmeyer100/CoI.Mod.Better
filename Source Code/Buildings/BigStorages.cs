...
namespace CoI.Mod.Better.Buildings
{
    internal partial class BigStorages : IModData
    {
        ...
        private int capacity_retired_waste_capacity;
        ...
        private void LoadData()
        {
            ...
            capacity_nuclear = BetterMod.Config.Storage.NuclearCapacity;
            capacity_nuclear = Mathf.Clamp(capacity_nuclear, VanillaConstants.NuclearStorageCapacity, int.MaxValue);
            
            capacity_retired_waste_capacity = BetterMod.Config.Storage.NuclearRetiredWasteCapacity;
            capacity_retired_waste_capacity = Mathf.Clamp(capacity_retired_waste_capacity, VanillaConstants.NuclearRetiredWasteCapacity, int.MaxValue);
