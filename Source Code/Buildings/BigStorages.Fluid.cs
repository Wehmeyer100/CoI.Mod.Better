...
namespace CoI.Mod.Better.Buildings
{
	internal partial class BigStorages : IModData
	{
		...
		private void FluidStoragesT1(ProtoRegistrator registrator)
		{
			...
			BetterDebug.Info("BigStorages >> FluidStoragesT1 (override:" + BetterMod.Config.Storage.OverrideVanilla + ") >> created!");
		}
		...
		private void FluidStoragesT2(ProtoRegistrator registrator)
		{
			...
			BetterDebug.Info("BigStorages >> FluidStoragesT2 (override:" + BetterMod.Config.Storage.OverrideVanilla + ") >> created!");
		}
		...
		private void FluidStoragesT3(ProtoRegistrator registrator)
		{
			...
			BetterDebug.Info("BigStorages >> FluidStoragesT3 (override:" + BetterMod.Config.Storage.OverrideVanilla + ") >> created!");
		}
		...
		private void FluidStoragesT4(ProtoRegistrator registrator)
		{
			...
			BetterDebug.Info("BigStorages >> FluidStoragesT4 (override:" + BetterMod.Config.Storage.OverrideVanilla + ") >> created!");
		}
